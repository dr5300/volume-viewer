...
export class Geometry {
	...
	computeVertexNormals() {
		...
		if (this._vertices) {
			...
			if (!this._normals || this._normals.needsUpdate) {
   ...
   get indexCount() { return this._drawRangeSet ? this._indexCount : this.indices.count(); }
    ...
    /**
     * Get UVW coordinates of the geometry.
     *
     * @returns UVW coordinates.
     */
    get uvw() { return this._uvw; }
     ...
     * Set UVW coordinates.
     *
     * @param values UVW coordinates.
     */
    set uvw(values) { this._uvw = values; }
